...
SOURCE_FOLDER = os.getenv("SOURCE_FOLDER", r"C:\Users\Redick.Taal\OneDrive - DigiPlus Interactive\Desktop\RED\.FRAUD & RISK\00_FraudandRisk_db\SOURCE\EKYC_SOURCE")

# Target table name in Postgres
TABLE_NAME = os.getenv("TABLE_NAME", "ekyc_clean")
